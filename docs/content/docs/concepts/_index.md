...
{{< cards >}}
  ...
  {{< card link="code-knowledge-graph" title="Code Knowledge Graph" subtitle="Tree-sitter AST indexing, KuzuDB storage, community detection, and agent tools for codebase understanding." icon="code" >}}
  {{< card link="programmatic-tool-calling" title="Programmatic Tool Calling" subtitle="Python-based tool execution that reduces context usage by 30-40%+." icon="terminal" >}}
