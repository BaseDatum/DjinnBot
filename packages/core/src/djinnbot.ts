...
// Dynamic import for SlackBridge and TelegramBridgeManager to avoid circular dependency
// @djinnbot/slack and @djinnbot/telegram depend on @djinnbot/core for types
