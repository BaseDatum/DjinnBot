...
export interface ChatMessageData {
  ...
  /** TTS audio attachment (generated by Fish Audio) */
  ttsAudio?: {
    attachmentId: string;
    filename: string;
    mimeType: string;
  ...
  if (message.type === 'assistant') {
    ...
    return (
      <div className={cn(
            ...
            {message.ttsAudio && (
              <div className="mt-2">
                <audio
                  ...
                  src={`${(window as any).__RUNTIME_CONFIG__?.API_URL || ''}/v1/chat/attachments/${message.ttsAudio.attachmentId}/content`}
                >
        ...
        {!isStreaming && displayContent && <CopyButton getText={() => displayContent} className="self-start mt-1" />}
      </div>
    );
  }
